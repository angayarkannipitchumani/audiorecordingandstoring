...
<input type="button" id="recordButton" value="Record/Stop"></input>

<!--  <input type="button" id="start-btn" value="Start recording"></input>
  <input type="button" id="stopbtn" value="Stop"disabled></input>-->
...
//var stops=document.getElementById("stopbtn");
        ...
        navigator.mediaDevices.getUserMedia({
           ...
           recorder.ondataavailable = function(e) {
                var _AudioFormat = "audio/wav";
                 // .weba = webaudio; subset of webm
                 audiochuncks=[];
                 audiochuncks.push(e.data);
                const blob = new Blob(audiochuncks, { type: 'audio/wav' });
          // createAudioElem convert blob to URL so it can be assigned to a audio src attribute
               ...
               // var preview = document.createElement('audio');
                ...
                var hf = document.createElement('a');
                  var  aud=document.getElementById("aus");
                    aud.src=url;
...
<br/>
<br/>
<p><font color="red"> Choose the audio file downloaded and upload the same</font></p>
